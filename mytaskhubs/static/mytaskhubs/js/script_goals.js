document.addEventListener("DOMContentLoaded", () => {
  ...
  const projects = document.querySelectorAll('#goalsContainer .card');
  ...
  // Filtro 2 (ordenação)
  // ---------------------
  const filter2 = document.getElementById('goalFilter2');
...
const filter3 = document.getElementById('goalFilter3');
